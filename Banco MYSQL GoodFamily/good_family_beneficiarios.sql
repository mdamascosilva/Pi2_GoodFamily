...
CREATE TABLE `beneficiarios` (
  ...
  PRIMARY KEY (`id`),
  KEY `beneficiarios_cidade_foreign` (`cidade`),
  KEY `beneficiarios_bairro_foreign` (`bairro`),
  CONSTRAINT `beneficiarios_bairro_foreign` FOREIGN KEY (`bairro`) REFERENCES `bairros` (`id`),
  CONSTRAINT `beneficiarios_cidade_foreign` FOREIGN KEY (`cidade`) REFERENCES `cidades` (`id`)
